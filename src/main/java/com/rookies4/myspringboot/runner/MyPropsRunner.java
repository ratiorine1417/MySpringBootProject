...
public class MyPropsRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        logger.info("Properties chimmy.name = {}", name);
        logger.info("Properties chimmy.age = {}", age);
        logger.info("Properties chimmy.fullName = {}", environment.getProperty("chimmy.fullName"));
        ...
        args.getOptionNames().forEach(new Consumer<String>() {
            ...
            public void accept(String s) {
                logger.debug("Inner Class 아큐먼트 이름 = {}", s);
            }
        });
